...
- [P1] If `github` is the next skill to activate, run `gh auth login` on this machine and reply when done so it can be verified.
...
- [P2] Decide whether future coding projects should be split into explicit project folders and labels up front.
